...
def interfaz_calorias(ventana):
    ...
    # Crea un marco para los gráficos, con un color de fondo y dimensiones específicas
    ...
    crear_graficos_calorias(frame_graphica, "Hoy")
    ...
    option_menu = ttk.OptionMenu(
        ...
        *graph_options,  # Opciones a mostrar
        command=lambda _: crear_graficos_calorias(frame_graphica, graph_type_var.get())  # Actualiza el gráfico al seleccionar una opción
    )
